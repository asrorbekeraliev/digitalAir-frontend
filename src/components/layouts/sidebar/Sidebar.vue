...
<div>      
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol id="speedometer" viewBox="0 0 16 16">
      <path fill="white" d="M8 2a.5.5 0 0 1 .5.5V4a.5.5 0 0 1-1 0V2.5A.5.5 0 0 1 8 2zM3.732 3.732a.5.5 0 0 1 .707 0l.915.914a.5.5 0 1 1-.708.708l-.914-.915a.5.5 0 0 1 0-.707zM2 8a.5.5 0 0 1 .5-.5h1.586a.5.5 0 0 1 0 1H2.5A.5.5 0 0 1 2 8zm9.5 0a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H12a.5.5 0 0 1-.5-.5zm.754-4.246a.389.389 0 0 0-.527-.02L7.547 7.31A.91.91 0 1 0 8.85 8.569l3.434-4.297a.389.389 0 0 0-.029-.518z"/>
      <path fill="white" fill-rule="evenodd" d="M6.664 15.889A8 8 0 1 1 9.336.11a8 8 0 0 1-2.672 15.78zm-4.665-4.283A11.945 11.945 0 0 1 8 10c2.186 0 4.236.585 6.001 1.606a7 7 0 1 0-12.002 0z"/>
    </symbol>
  </svg>



    <div class="d-flex flex-column flex-shrink-0 p-3 text-white mobile-cover" style="width: 14vw; min-height: 80vh; backdrop-filter:blur(10px) brightness(60%) contrast(80%);">
      <a href="/dashboard" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none mobile">
        <img src="../../../assets/logo.png" width="80" alt="" srcset="" style="margin-left: 50%">
      </a>
      <hr>
      <ul class="nav nav-pills flex-column mb-auto">
        <li>
          <a href="#" class="nav-link text-white" aria-current="page">
            ...
            <span class="mobile">Asosiy</span>
          </a>
        </li>
        <li>
          <a href="#" class="nav-link text-white">
            <svg class="bi me-2" width="16" height="16"><use xlink:href="#speedometer2"/></svg>
            <span class="mobile">Panel</span>
          </a>
        </li>
        <li>
          <a href="/users" class="nav-link text-white">
            <svg class="bi me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>
            <span class="mobile">Foydalanuvchilar</span>
          </a>
        </li>
        <li>
          <a href="/zones" class="nav-link text-white">
            <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>
            <span class="mobile">Hududlar</span>
          </a>
        </li>
        <li>
          <a href="#" class="nav-link text-white">
            <svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"/></svg>
            <span class="mobile">Qurilmalar</span>
          </a>
        </li>
        
      </ul>
      <hr>
      <div class="dropdown" style="padding-bottom: 15vh;">
        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="https://media.licdn.com/dms/image/D4D03AQFRbQv3v3bySw/profile-displayphoto-shrink_200_200/0/1692172669730?e=2147483647&v=beta&t=L-3ICm_RpHQ6sxO-8Z1W_lXg7f5xJDx3uPpC-zcSmiU" alt="" width="32" height="32" class="rounded-circle me-2">
          <strong class="mobile">{{ firstname || 'Name' }}</strong>
        </a>
        <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
          <li><a class="dropdown-item" href="#">Yangi loyiha...</a></li>
          <li><a class="dropdown-item" href="#">Sozlamalar</a></li>
          <li><a class="dropdown-item" href="#">Profil ma'lumotlari</a></li>
